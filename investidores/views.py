...
def sugestao(request):
    ...
    if request.method == "GET":   
        ...
        area = request.POST.getlist('area') #Select multiplo
...
def ver_empresa(request, id):
    ...
    # Listar métricas dinâmicas
    metricas = {
        'total_investido': sum(pi.valor for pi in proposta_investimentos),
        'media_valor_proposta': sum(pi.valor for pi in proposta_investimentos) / len(proposta_investimentos) if proposta_investimentos else 0,
