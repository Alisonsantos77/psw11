...
from django.utils.safestring import mark_safe #Considera a string como segura para ser exibida no navegador
...
class Empresas(models.Model):
    ...
    @property #Faz se comportar como uma propriedade
    def status(self):
